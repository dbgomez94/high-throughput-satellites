...
figure
histogram2(Roic,NPV,x_axis,y_axis,'Normalization','pdf');
xlabel('ROIC')
ylabel('NPV')
zlabel('PDF')

figure
histogram2(Roic,NPV,x_axis,y_axis,'Normalization','cdf');
xlabel('ROIC')
ylabel('NPV')
zlabel('CDF')
